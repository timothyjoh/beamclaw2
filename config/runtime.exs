...
#
#     PHX_SERVER=true bin/beamclaw2 start
#
...
if System.get_env("PHX_SERVER") do
  config :beamclaw2, Beamclaw2Web.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :beamclaw2, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
